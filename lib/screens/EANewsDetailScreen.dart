            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: Stack(
                  ...
                  children: [
                    Image.asset(event_ic_paris, fit: BoxFit.cover, width: context.width()),
                  ],
                ),
              ),
              ...
              Stack(
                ...
                children: [
                  ...
                  Positioned(
                    right: 16,
                    top: 16,
                    child: Icon(like! ? Icons.favorite : Icons.favorite_border, color: like! ? redColor : white, size: 22).onTap(() {
                      like = !like!;
                      setState(() {});
                    }),
                  ),
